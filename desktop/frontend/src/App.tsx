...
import { GetDomains, GetStatus, AddDomain, RemoveDomain, GetConfig, SetConfig, IsDaemonRunning, StopDaemon } from '../wailsjs/go/main/App';
import './App.css';
  ...
  if (!daemonRunning) {
    return (
      <div className="center-content">
        <img src="/src/assets/logo.svg" alt="Hatch" width="48" height="44" className="logo-img" />
